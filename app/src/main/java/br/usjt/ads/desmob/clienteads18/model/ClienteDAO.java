        ...
        if(clientes == null){
            ...
            clientes[0] = new Cliente(1, "Star Wars VII", "d171215", " JJ Abrams", " 17/12/2015", " Ficção Científica/Fantasia",
                    " A queda de Darth Vader e do Império levou ao surgimento de uma nova força sombria: a Primeira Ordem. Eles procuram o jedi Luke Skywalker, " +
                            ...
                            "encontram com Han Solo e sua Millenium Falcon e juntos tentam ajudar a encontrar Luke, antes que seja tarde demais. ", " 97%", " 2,066 Bilhões USD", " Daisy Ridley, John Boyega, Oscar Isaac, Adam Driver" +
                    ", Harison Ford, Carrie Fishier, Mark Hamill.");
            ...
            clientes[1] = new Cliente(2,"Star Wars VIII","d141217", " Rian Johnson"  , " 14/12/2017", " Ficção Científica/Fantasia", " A tranquila e solitária vida de Luke Skywalker sofre uma reviravolta quando ele conhece Rey, " +
                    ...
                    "Enquanto isso, Líder Snoke, Kylo Ren e General Hux lideram a Primeira Ordem para um ataquem contra a Resistência pela supremacia da galáxia.", " 88%", " 1,321 Bilhão USD", " Daisy Ridley, John Boyega, Oscar Isaac, Adam Driver, Mark Hamill, Carrie Fishier.");
            ...
            clientes[17] = new Cliente(18,"Dragon Ball Z: A Batalha dos Deuses","dd", " Masahiro Hosoda"  , " 11/10/2013", " Fantasia/Ação", " Bills, o deus da destruição, despertou depois de anos de hibernação. Ao escutar que um Super Saiyajin conseguiu vencer Freeza, Bills vai atrás de Goku e de um suposto Deus Super Saiyajin. " +
                    "Goku precisa se preparar para enfrentar uma força que jamais havia vivenciado.", " 85%", " 52,76 Milhões USD", "");

            clientes[18] = new Cliente(19,"Dragon Ball Z: O Renascimento de F","ddd", " Tadayoshi Yamamuro",  " 18/06/2015", " Fantasia/Ação", " Remanescentes do exército do vilão Freeza, chegam à Terra em busca das Esferas do Dragão para ressuscitar o seu antigo líder." +
